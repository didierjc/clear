<?php
	...
	*/
	function callHook() {
		...
		$controller = strtolower('ctrl_'.$controller);
		array_shift($urlArray); // array_shift | shifts the first value of the array off and returns it, shortening the array by one element and moving everything down
